...
# For building packages, you need to tell vcpkg that you want to use the mingw triplet. 
# This can be done in different ways. When Visual Studio is not installed, you must also set the host triplet to mingw. 
